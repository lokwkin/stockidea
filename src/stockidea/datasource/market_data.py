...
async def get_index_prices(db_session: AsyncSession, index: StockIndex, from_date: date, to_date: date) -> list[StockPrice]:
    """
...
async def get_index_price_at_date(db_session: AsyncSession, index: StockIndex, target_date: date, nearest: bool = False) -> StockPrice:
    """
...
async def get_stock_price_history(db_session: AsyncSession, symbol: str, from_date: date, to_date: date) -> list[StockPrice]:
    """
...
async def get_stock_price_at_date(db_session: AsyncSession, symbol: str, target_date: date, nearest: bool = False) -> StockPrice:
    """
