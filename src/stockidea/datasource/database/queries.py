...
async def load_stock_indicators(
    ...
    return StockIndicators(
        ...
        slope_pct_4w=record.slope_pct_4w,
        ...
        acceleration_pct_4w=record.acceleration_pct_4w,
        acceleration_pct_13w=record.acceleration_pct_13w,
        acceleration_pct_26w=record.acceleration_pct_26w,
        acceleration_pct_52w=record.acceleration_pct_52w,
